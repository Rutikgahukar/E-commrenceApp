...
import com.ezyshopproject.ezycarts.databinding.ActivityProductDetailedBinding;
...
public class ProductDetailedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.addToCartBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ProductDetailedActivity.this, "Added in Cart", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    void getProductDetailed(int id){
